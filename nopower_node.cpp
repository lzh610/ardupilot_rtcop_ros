         ...
         ardupilot_rtcop_ros::activation_msg::Response &res)
{
    ...
    if(strcmp(req.activation.c_str(),"nopower_activate") == 0 || strcmp(req.activation.c_str(),"nopower_deactivate") == 0)
...
int main(int argc, char **argv){
    ros::init(argc,argv,"nopower_node");
    ros::NodeHandle nopower_node;
    ros::ServiceServer service = nopower_node.advertiseService("nopower_activation", msg_return);
    ros::spin();
    return 0;
}