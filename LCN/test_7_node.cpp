         ...
         ardupilot_rtcop_ros::activation_msg::Response &res)
{
    ...
    if(strcmp(req.activation.c_str(),"test_7_activate") == 0 || strcmp(req.activation.c_str(),"test_7_deactivate") == 0)
...
int main(int argc, char **argv){
    ros::init(argc,argv,"test_7_node");
    ros::NodeHandle test_7_node;
    ros::ServiceServer service = test_7_node.advertiseService("test_7_activation", msg_return);
    ros::spin();
    return 0;
}