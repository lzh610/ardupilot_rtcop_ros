         ...
         ardupilot_rtcop_ros::activation_msg::Response &res)
{
    ...
    if(strcmp(req.activation.c_str(),"test_4_activate") == 0 || strcmp(req.activation.c_str(),"test_4_deactivate") == 0)
...
int main(int argc, char **argv){
    ros::init(argc,argv,"test_4_node");
    ros::NodeHandle test_4_node;
    ros::ServiceServer service = test_4_node.advertiseService("test_4_activation", msg_return);
    ros::spin();
    return 0;
}