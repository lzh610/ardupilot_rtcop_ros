         ...
         ardupilot_rtcop_ros::activation_msg::Response &res)
{
    ...
    if(strcmp(req.activation.c_str(),"test_14_activate") == 0 || strcmp(req.activation.c_str(),"test_14_deactivate") == 0)
...
int main(int argc, char **argv){
    ros::init(argc,argv,"test_14_node");
    ros::NodeHandle test_14_node;
    ros::ServiceServer service = test_14_node.advertiseService("test_14_activation", msg_return);
    ros::spin();
    return 0;
}