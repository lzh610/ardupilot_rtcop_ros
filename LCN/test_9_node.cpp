         ...
         ardupilot_rtcop_ros::activation_msg::Response &res)
{
    ...
    if(strcmp(req.activation.c_str(),"test_9_activate") == 0 || strcmp(req.activation.c_str(),"test_9_deactivate") == 0)
...
int main(int argc, char **argv){
    ros::init(argc,argv,"test_9_node");
    ros::NodeHandle test_9_node;
    ros::ServiceServer service = test_9_node.advertiseService("test_9_activation", msg_return);
    ros::spin();
    return 0;
}