         ...
         ardupilot_rtcop_ros::activation_msg::Response &res)
{
    ...
    if(strcmp(req.activation.c_str(),"test_2_activate") == 0 || strcmp(req.activation.c_str(),"test_2_deactivate") == 0)
...
int main(int argc, char **argv){
    ros::init(argc,argv,"test_2_node");
    ros::NodeHandle test_2_node;
    ros::ServiceServer service = test_2_node.advertiseService("test_2_activation", msg_return);
    ros::spin();
    return 0;
}