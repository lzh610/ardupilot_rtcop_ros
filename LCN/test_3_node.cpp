         ...
         ardupilot_rtcop_ros::activation_msg::Response &res)
{
    ...
    if(strcmp(req.activation.c_str(),"test_3_activate") == 0 || strcmp(req.activation.c_str(),"test_3_deactivate") == 0)
...
int main(int argc, char **argv){
    ...
    ros::NodeHandle test_3_node;
    ros::ServiceServer service = test_3_node.advertiseService("test_3_activation", msg_return);
    ros::spin();
    return 0;
}