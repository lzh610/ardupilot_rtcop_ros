         ...
         ardupilot_rtcop_ros::activation_msg::Response &res)
{
    ...
    if(strcmp(req.activation.c_str(),"test_10_activate") == 0 || strcmp(req.activation.c_str(),"test_10_deactivate") == 0)
...
int main(int argc, char **argv){
    ros::init(argc,argv,"test_10_node");
    ros::NodeHandle test_10_node;
    ros::ServiceServer service = test_10_node.advertiseService("test_10_activation", msg_return);
    ros::spin();
    return 0;
}