         ...
         ardupilot_rtcop_ros::activation_msg::Response &res)
{
    ...
    if(strcmp(req.activation.c_str(),"test_5_activate") == 0 || strcmp(req.activation.c_str(),"test_5_deactivate") == 0)
...
int main(int argc, char **argv){
    ros::init(argc,argv,"test_5_node");
    ros::NodeHandle test_5_node;
    ros::ServiceServer service = test_5_node.advertiseService("test_5_activation", msg_return);
    ros::spin();
    return 0;
}