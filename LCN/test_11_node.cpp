         ...
         ardupilot_rtcop_ros::activation_msg::Response &res)
{
    ...
    if(strcmp(req.activation.c_str(),"test_11_activate") == 0 || strcmp(req.activation.c_str(),"test_11_deactivate") == 0)
...
int main(int argc, char **argv){
    ros::init(argc,argv,"test_11_node");
    ros::NodeHandle test_11_node;
    ros::ServiceServer service = test_11_node.advertiseService("test_11_activation", msg_return);
    ros::spin();
    return 0;
}