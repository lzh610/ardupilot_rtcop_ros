         ...
         ardupilot_rtcop_ros::activation_msg::Response &res)
{
    ...
    if(strcmp(req.activation.c_str(),"test_6_activate") == 0 || strcmp(req.activation.c_str(),"test_6_deactivate") == 0)
...
int main(int argc, char **argv){
    ...
    ros::NodeHandle test_6_node;
    ros::ServiceServer service = test_6_node.advertiseService("test_6_activation", msg_return);
    ros::spin();
    return 0;
}