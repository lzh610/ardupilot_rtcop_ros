         ...
         ardupilot_rtcop_ros::activation_msg::Response &res)
{
    ...
    if(strcmp(req.activation.c_str(),"test_13_activate") == 0 || strcmp(req.activation.c_str(),"test_13_deactivate") == 0)
...
int main(int argc, char **argv){
    ros::init(argc,argv,"test_13_node");
    ros::NodeHandle test_13_node;
    ros::ServiceServer service = test_13_node.advertiseService("test_13_activation", msg_return);
    ros::spin();
    return 0;
}