         ...
         ardupilot_rtcop_ros::activation_msg::Response &res)
{
    ...
    if(strcmp(req.activation.c_str(),"test_8_activate") == 0 || strcmp(req.activation.c_str(),"test_8_deactivate") == 0)
...
int main(int argc, char **argv){
    ros::init(argc,argv,"test_8_node");
    ros::NodeHandle test_8_node;
    ros::ServiceServer service = test_8_node.advertiseService("test_8_activation", msg_return);
    ros::spin();
    return 0;
}