         ...
         ardupilot_rtcop_ros::activation_msg::Response &res)
{
    ...
    if(strcmp(req.activation.c_str(),"test_12_activate") == 0 || strcmp(req.activation.c_str(),"test_12_deactivate") == 0)
...
int main(int argc, char **argv){
    ros::init(argc,argv,"test_12_node");
    ros::NodeHandle test_12_node;
    ros::ServiceServer service = test_12_node.advertiseService("test_12_activation", msg_return);
    ros::spin();
    return 0;
}