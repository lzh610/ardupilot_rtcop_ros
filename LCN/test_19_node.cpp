         ...
         ardupilot_rtcop_ros::activation_msg::Response &res)
{
    ...
    if(strcmp(req.activation.c_str(),"test_19_activate") == 0 || strcmp(req.activation.c_str(),"test_19_deactivate") == 0)
...
int main(int argc, char **argv){
    ros::init(argc,argv,"test_19_node");
    ros::NodeHandle test_19_node;
    ros::ServiceServer service = test_19_node.advertiseService("test_19_activation", msg_return);
    ros::spin();
    return 0;
}