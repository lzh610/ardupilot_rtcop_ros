         ...
         ardupilot_rtcop_ros::activation_msg::Response &res)
{
    ...
    if(strcmp(req.activation.c_str(),"test_16_activate") == 0 || strcmp(req.activation.c_str(),"test_16_deactivate") == 0)
...
int main(int argc, char **argv){
    ros::init(argc,argv,"test_16_node");
    ros::NodeHandle test_16_node;
    ros::ServiceServer service = test_16_node.advertiseService("test_16_activation", msg_return);
    ros::spin();
    return 0;
}