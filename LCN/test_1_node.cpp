         ...
         ardupilot_rtcop_ros::activation_msg::Response &res)
{
    ...
    if(strcmp(req.activation.c_str(),"test_1_activate") == 0 || strcmp(req.activation.c_str(),"test_1_deactivate") == 0)
...
int main(int argc, char **argv){
    ros::init(argc,argv,"test_1_node");
    ros::NodeHandle test_1_node;
    ros::ServiceServer service = test_1_node.advertiseService("test_1_activation", msg_return);
    ros::spin();
    return 0;
}