         ...
         ardupilot_rtcop_ros::activation_msg::Response &res)
{
    ...
    if(strcmp(req.activation.c_str(),"test_15_activate") == 0 || strcmp(req.activation.c_str(),"test_15_deactivate") == 0)
...
int main(int argc, char **argv){
    ros::init(argc,argv,"test_15_node");
    ros::NodeHandle test_15_node;
    ros::ServiceServer service = test_15_node.advertiseService("test_15_activation", msg_return);
    ros::spin();
    return 0;
}