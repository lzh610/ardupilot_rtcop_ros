         ...
         ardupilot_rtcop_ros::activation_msg::Response &res)
{
    ...
    if(strcmp(req.activation.c_str(),"test_18_activate") == 0 || strcmp(req.activation.c_str(),"test_18_deactivate") == 0)
...
int main(int argc, char **argv){
    ros::init(argc,argv,"test_18_node");
    ros::NodeHandle test_18_node;
    ros::ServiceServer service = test_18_node.advertiseService("test_18_activation", msg_return);
    ros::spin();
    return 0;
}