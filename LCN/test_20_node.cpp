         ...
         ardupilot_rtcop_ros::activation_msg::Response &res)
{
    ...
    if(strcmp(req.activation.c_str(),"test_20_activate") == 0 || strcmp(req.activation.c_str(),"test_20_deactivate") == 0)
...
int main(int argc, char **argv){
    ros::init(argc,argv,"test_20_node");
    ros::NodeHandle test_20_node;
    ros::ServiceServer service = test_20_node.advertiseService("test_20_activation", msg_return);
    ros::spin();
    return 0;
}